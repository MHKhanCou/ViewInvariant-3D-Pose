...
- Five of nine pre-registered experiments failed and are reported as failures,
  and a sixth returned a competing baseline that beats the proposed method on
  every one of 180 pairs and all 15 actions.
