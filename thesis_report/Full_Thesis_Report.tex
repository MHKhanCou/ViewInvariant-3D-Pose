...
\label{tab:summary}
{\fontsize{10}{12}\selectfont
% Ragged right in the fixed-width columns: justifying prose inside a 3.1cm
% column produces badly loose lines, which is where every underfull box in this
% document came from.
\begin{tabular}{>{\raggedright\arraybackslash}p{4.6cm}>{\raggedright\arraybackslash}p{3.1cm}>{\raggedright\arraybackslash}p{3.1cm}l}
\hline
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.60\textwidth]{images/fig_29pairs.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.60\textwidth]{images/fig_oracle.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.58\textwidth]{images/fig_multiscale.png}
