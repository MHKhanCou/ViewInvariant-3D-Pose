...
\begin{table}[h]
\centering
\caption{Median fusion by action, the six worst and four best of fifteen. The final column is the same fusion with anatomical reflection handling, included because it bears on the diagnosis below.}
